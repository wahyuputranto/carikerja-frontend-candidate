          ...
          <div v-for="app in filteredApplications" :key="app.application.id" class="card">
            ...
            <div class="mt-4 bg-blue-50 p-4 rounded-lg text-sm text-blue-800 flex items-start">
                ...
                <div class="flex-1 space-y-2">
                    ...
                    <!-- Offering Details -->
                    <div v-if="['OFFERING', 'HIRED', 'PROCESSING_VISA', 'DEPLOYED'].includes(app.application.status)" class="mt-2 space-y-1 bg-purple-50/50 p-3 rounded border border-purple-100">
                        <p class="font-semibold text-purple-900 mb-2 flex items-center">
                            <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                            Offering Details
                        </p>
                        <p class="flex items-center" v-if="app.application.offering_letter_path">
                            <span class="font-semibold w-32">Dokumen:</span>
                            <button @click="downloadOfferingLetter(app.application.offering_letter_path)" class="text-purple-700 hover:text-purple-900 font-medium underline flex items-center">
                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <p class="text-purple-800 text-xs mt-2">
